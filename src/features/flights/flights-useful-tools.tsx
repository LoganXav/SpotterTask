      ...
      details: (
        <Box className="space-y-4">
          ...
          <Typography className="font-roboto" variant="body1">
            ...
            <strong>Date grid</strong> and <strong>Price graph</strong> options
            on the Search page to find the cheapest days to fly and book your
            tickets.
          </Typography>
    ...
    },
    {
      ...
      details: (
        <Box className="space-y-4">
          ...
          <Typography className="font-roboto" variant="body1">
            Real-time insights can tell you if a ticket price is lower or higher
            than usual, and if the fare you’re seeing is a good price. So, you
            don’t have to worry about paying too much for a flight or missing
            out on the cheapest time to book. On some routes, you might also see
            historical data that helps you better understand how flight prices
            vary over time.
          </Typography>
      ...
      details: (
        <Box className="space-y-4">
          ...
          <Typography className="font-roboto" variant="body1">
            ...
            flights and opt-in to receive email updates when the price changes.
            Once that's done, you can come back to your Tracked Flights page to
            monitor prices whenever you like, or relax knowing you’ll never miss
            a flight deal.
          </Typography>
          <Box
            style={{
        ...
        <Box className="flex flex-col gap-4">
          {tools.map((tool) => (
            ...
            >
              ...
              {selectedTool.id === tool.id && (
                <Box className="hidden md:flex absolute top-1/2 -right-5 transform -translate-y-1/2 w-0 h-0 border-t-[20px] border-t-transparent border-b-[20px] border-b-transparent border-l-[20px] border-l-primary-contrastText/10" />
              )}
            </Box>
          ))}
        </Box>
